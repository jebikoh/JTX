...
TEST_CASE("BB3f corner", "[BB3f]") {
    jtx::BBox3f bb(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{2.0f, 2.0f, 2.0f});
...
TEST_CASE("BB3f merge with BB3f", "[BB3f]") {
    jtx::BBox3f bb1(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{2.0f, 2.0f, 2.0f});
    jtx::BBox3f bb2(jtx::Point3f{3.0f, 3.0f, 3.0f}, jtx::Point3f{4.0f, 4.0f, 4.0f});
    bb1.merge(bb2);
...
TEST_CASE("BB3f overlaps: does overlap", "[BB3f]") {
    jtx::BBox3f bb1(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{2.0f, 2.0f, 2.0f});
    jtx::BBox3f bb2(jtx::Point3f{1.5f, 1.5f, 1.5f}, jtx::Point3f{2.5f, 2.5f, 2.5f});
    REQUIRE(bb1.overlaps(bb2) == true);
}

TEST_CASE("BB3f overlaps: does not overlap", "[BB3f]") {
    jtx::BBox3f bb1(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{2.0f, 2.0f, 2.0f});
    jtx::BBox3f bb2(jtx::Point3f{2.5f, 2.5f, 2.5f}, jtx::Point3f{3.5f, 3.5f, 3.5f});
    REQUIRE(bb1.overlaps(bb2) == false);
}

TEST_CASE("BB3f overlaps: equal edge", "[BB3f]") {
    jtx::BBox3f bb1(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{2.0f, 2.0f, 2.0f});
    jtx::BBox3f bb2(jtx::Point3f{2.0f, 2.0f, 2.0f}, jtx::Point3f{2.5f, 2.5f, 2.5f});
    REQUIRE(bb1.overlaps(bb2) == true);
}
...
TEST_CASE("BB3f shrink", "[BB3f]") {
    jtx::BBox3f bb(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{4.0f, 4.0f, 4.0f});
    bb.shrink(1.0f);
...
TEST_CASE("BB3f maxDim", "[BB3f]") {
    jtx::BBox3f bb(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{4.0f, 4.0f, 5.0f});
    REQUIRE(bb.maxDim() == 2);
}
...
TEST_CASE("BB3f bounding sphere", "[BB3f]") {
    jtx::BBox3f bb(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{3.0f, 3.0f, 3.0f});
    jtx::Point3f center;
    float radius;
...
TEST_CASE("BB3f intersect", "[BB3f]") {
    jtx::BBox3f bb1(jtx::Point3f{1.0f, 1.0f, 1.0f}, jtx::Point3f{3.0f, 3.0f, 3.0f});
    jtx::BBox3f bb2(jtx::Point3f{2.0f, 2.0f, 2.0f}, jtx::Point3f{4.0f, 4.0f, 4.0f});
...
TEST_CASE("BB3f distance", "[BB3f]") {
    jtx::Point3f p(1.0f, 1.0f, 1.0f);
    jtx::BBox3f bb(jtx::Point3f{2.0f, 2.0f, 2.0f}, jtx::Point3f{4.0f, 4.0f, 4.0f});
...
TEST_CASE("BB2f corner", "[BB2f]") {
    jtx::BBox2f bb(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{2.0f, 2.0f});
...
TEST_CASE("BB2f merge with BB2f", "[BB2f]") {
    jtx::BBox2f bb1(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{2.0f, 2.0f});
    jtx::BBox2f bb2(jtx::Point2f{3.0f, 3.0f}, jtx::Point2f{4.0f, 4.0f});
    bb1.merge(bb2);
...
TEST_CASE("BB2f overlaps: does overlap", "[BB2f]") {
    jtx::BBox2f bb1(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{2.0f, 2.0f});
    jtx::BBox2f bb2(jtx::Point2f{1.5f, 1.5f}, jtx::Point2f{2.5f, 2.5f});
    REQUIRE(bb1.overlaps(bb2) == true);
}

TEST_CASE("BB2f overlaps: does not overlap", "[BB2f]") {
    jtx::BBox2f bb1(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{2.0f, 2.0f});
    jtx::BBox2f bb2(jtx::Point2f{2.5f, 2.5f}, jtx::Point2f{3.5f, 3.5f});
    REQUIRE(bb1.overlaps(bb2) == false);
}

TEST_CASE("BB2f overlaps: equal edge", "[BB2f]") {
    jtx::BBox2f bb1(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{2.0f, 2.0f});
    jtx::BBox2f bb2(jtx::Point2f{2.0f, 2.0f}, jtx::Point2f{2.5f, 2.5f});
    REQUIRE(bb1.overlaps(bb2) == true);
}
...
TEST_CASE("BB2f shrink", "[BB2f]") {
    jtx::BBox2f bb(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{4.0f, 4.0f});
    bb.shrink(1.0f);
...
TEST_CASE("BB2f diagonal", "[BB2f]") {
    jtx::BBox2f bb(jtx::Point2f{1.0f, 1.0}, jtx::Point2f{4.0f, 4.0f});
    REQUIRE(bb.diagonal() == jtx::Vec2f{3.0f, 3.0f});
}

TEST_CASE("BB2f maxDim", "[BB2f]") {
    jtx::BBox2f bb(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{4.0f, 5.0f});
    REQUIRE(bb.maxDim() == 1);
}
...
TEST_CASE("BB2f intersect", "[BB2f]") {
    jtx::BBox2f bb1(jtx::Point2f{1.0f, 1.0f}, jtx::Point2f{3.0f, 3.0f});
    jtx::BBox2f bb2(jtx::Point2f{2.0f, 2.0f}, jtx::Point2f{4.0f, 4.0f});
    auto bb3 = jtx::intersect(bb1, bb2);
